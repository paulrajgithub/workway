package com.asdev.circleimageview;
...
public class CompatCircleImageView extends AppCompatImageView {
    ...
    public CompatCircleImageView(Context context) {
        super(context);

        init();
    }

    public CompatCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CompatCircleImageView(Context context, AttributeSet attrs, int defStyle) {
