...
public class CameraView extends FrameLayout {
     ...
     */
    public void removeAllCallbacks() { mCallbacks.removeAll(); }
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        public void removeAll() { mCallbacks.clear(); }
    ...
    /**
     * Callback for only receiving the picture data.
     */
    public static class PictureCallback extends Callback {

        @NonNull
        private PictureReceiver receiver;

        public PictureCallback(@NonNull PictureReceiver receiver) {
            this.receiver = receiver;
        }

        @Override
        public void onPictureTaken(CameraView cameraView, byte[] data) {
            receiver.onPictureTaken(cameraView, data);
        }

    }

    /**
     * An interface which accepts the picture data as opposed to an abstract class.
     */
    public interface PictureReceiver {

        void onPictureTaken(@NonNull CameraView cameraView, @NonNull byte[] jpegData);
