...
class LauncherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            vanillaDb.setPersistenceEnabled(false) // TODO: enable persistence?
    ...
    /**
     * Whether or not the main activity has already been launched.
     */
    ...
    private fun launchSignIn() {
        ...
        val facebookPerms = listOf("user_friends")
        // build a list of providers
        val providers = listOf(AuthUI.IdpConfig.Builder(AuthUI.FACEBOOK_PROVIDER).setPermissions(facebookPerms).build(),
